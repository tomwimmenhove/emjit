...
//	cout << "bla: " << div_fn(42 * 3, 3) << '\n';
	...
	inst_stream << x64_instruction({0x6b, 0xc7, 0x0a});
	inst_stream << x64_imul(x64_regs::rbx, x64_regs::r12, static_cast<int8_t>(10));
	inst_stream << x64_imul(x64_regs::ebx, x64_regs::r12d, static_cast<int8_t>(10));
	inst_stream << x64_imul(x64_regs::bx, x64_regs::r12w, static_cast<int8_t>(10));

	inst_stream << x64_imul(x64_regs::rbx, x64_regs::r12, static_cast<int32_t>(10));
	inst_stream << x64_imul(x64_regs::ebx, x64_regs::r12d, static_cast<int32_t>(10));
	inst_stream << x64_imul(x64_regs::bx, x64_regs::r12w, static_cast<int16_t>(10));
	inst_stream << x64_ret();
...
//
//	inst_stream << x64_imul(x64_regs::r12, x64_reg_addr(x64_regs::ebp));
//
//	inst_stream << x64_imul(x64_regs::rax, x64_reg_addr(x64_regs::r12), 12, x64_sib_scale::s8, 100);
//
//	inst_stream << x64_mov(x64_regs::rax, x64_regs::rax);
}
